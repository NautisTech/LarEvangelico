					...
					<div className="ssr-variant hidden-d9yx5v">
						...
						>
							...
							>
								...
								<h5 className="framer-text framer-styles-preset-1js54ic">
									{t("causas_specific.sections.challenge")}
								</h5>
							...
							<div
								className="framer-2pb0ha"
								data-framer-name="Introduction"
								data-framer-component-type="RichTextContainer"
								style={{ transform: "none" }}
							>
								<h5 className="framer-text framer-styles-preset-1js54ic">
									{t("causas_specific.sections.problem")}
								</h5>
								...
								<h5 className="framer-text framer-styles-preset-1js54ic">
									{t("causas_specific.sections.solution")}
								</h5>
						...
						<div
							className="framer-1nhrzuu"
							data-framer-name="Right"
						>
							<div className="ssr-variant hidden-d9yx5v">
								<div
									className="framer-3jamzk"
									data-border="true"
									data-framer-name="Form Bar"
									style={{
										willChange: "transform",
										opacity: "1",
										transform: "none",
								...
								>
									<div
										className="framer-l9dh2t"
										data-framer-name="Form Wrap"
									>
										<div
											className="framer-1m3wj2b"
											data-framer-name="Help the cause!"
											data-framer-component-type="RichTextContainer"
											style={{
												transform: "none",
												display: "flex",
