		...
		<>
			<section className="framer-ohulhj" data-framer-name="Main Banner">
						...
						>
							...
							>
								<img
									...
									width="1600"
									height="1419"
									sizes="(min-width: 1200px) calc(100vw - 40px), (min-width: 810px) and (max-width: 1199px) calc(100vw - 40px), (max-width: 809px) calc(100vw - 40px)"
									src={imagemPrincipal}
									alt={causa.titulo}
									style={{
										display: "block",
				...
				<div className="ssr-variant hidden-d9yx5v">
					...
					>
						<div
							className="framer-1nm9qe6"
							data-framer-name="Title"
						>
							<div
								className="framer-1sbp8nz"
								data-framer-name="Access to Education"
