            ...
            <section className="framer-qgyhda" data-framer-name="Causes">
                <div className="framer-q9xl3o" data-framer-name="Container">
                    <div className="ssr-variant hidden-d9yx5v">
                        <div className="framer-gfw0ym" data-framer-name="Our Key Causes" data-framer-component-type="RichTextContainer"
                            ...
                            <h3 className="framer-text framer-styles-preset-ehrduw" data-styles-preset="Pm0hsra8F"
                                style={{ textAlign: "center" }}>Outras causas</h3>
                    ...
                    <div className="framer-16kj5yn" data-framer-name="Causes Lists">
                        <div className="ssr-variant hidden-wz6xei">
                            {causas.map((causa, index) => {
                                ...
                                return (
                                    <>
                                        <div className="ssr-variant hidden-d9yx5v">
                                            <div className="framer-1plvl6g" style={{
                                                ...
                                                <div className="framer-1cdp940-container">
                                                    <div className="framer-d7En5 framer-RcNjK framer-Yo47e framer-jRQOc framer-1ex0le0 framer-v-1ex0le0"
                                                        ...
                                                        <div className="framer-fjc7qo" data-framer-name="Content"><a className="framer-nah7t3 framer-yk3d88" data-framer-name="Figure" onClick={() => handleCausaClick(causa.id!)}
                                                            data-framer-page-link-current="true" style={{
                                                            ...
                                                            <figure className="framer-1rewzo1" data-framer-name="Image">
                                                                <div style={{ "position": "absolute", "borderTopLeftRadius": "inherit", "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "top": "0px", "right": "0px", "bottom": "0px", "left": "0px" }} data-framer-background-image-wrapper="true"><img decoding="async" width="1600" height="1209"
                                                                    src={imagemPrincipal}
                                                                    alt={causa.titulo} style={{ "display": "block", "width": "100%", "height": "100%", "borderTopLeftRadius": "inherit", "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "objectPosition": "center center", "objectFit": "cover" }} />
                                                                </div>
                                                            </figure>
                                                            {causa.objetivo && (
                                                                    ...
                                                                    <div className="framer-aE08l framer-2Vypl framer-jRQOc framer-1bdcnzx framer-v-1bdcnzx" data-framer-name="Primary" style={{ "backgroundColor": "var(--token-065bffec-4ac7-4625-aced-acd0f0a75d90, rgb(254, 206, 102))", "borderBottomLeftRadius": "4px", "borderBottomRightRadius": "4px", "borderTopLeftRadius": "4px", "borderTopRightRadius": "4px" }}>
                                                                        ...
                                                                        <div className="framer-1y22eeh" data-framer-name="$114,000" data-framer-component-type="RichTextContainer" style={{ "transform": "none" }}>
                                                                            <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw">
                                                                                {formatCurrency(causa.objetivo)}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            )}
                                                                ...
                                                                <div className="framer-cs2fea" data-framer-name="Title Content">
                                                                    <div className="framer-t0iiul" data-framer-name="Feeding the Hungry" data-framer-component-type="RichTextContainer"
                                                                        ...
                                                                        <h5 className="framer-text framer-styles-preset-1js54ic" data-styles-preset="YoG87oFzq">
                                                                            <a className="framer-text framer-styles-preset-ixgrlg" data-styles-preset="PGCP_hdlP" onClick={() => handleCausaClick(causa.id!)} data-framer-page-link-current="true">{causa.titulo}</a>
                                                                        </h5>
                                                                ...
                                                                <div className="framer-71cqzm-container" style={{ marginTop: "20px" }}>
                                                                    <div
                                                                        ...
                                                                        <div className="framer-uhgsoe" data-framer-name="Join us Today" data-framer-component-type="RichTextContainer" style={{ "transform": "none" }}>
                                                                            <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw" style={{ color: "white" }}>
                                                                                Saber Mais</p>
                                                                        </div>
                                                ...
                                                <div className="framer-1cdp940-container">
                                                    <div className="framer-d7En5 framer-RcNjK framer-Yo47e framer-jRQOc framer-1ex0le0 framer-v-lfs6ys"
                                                        data-border="true" data-framer-name="Mobile" style={{
                                                            "--1an90bp":
                                                                "25px", borderBottomWidth: "1px", borderColor:
                                                                "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                                            borderStyle: "solid", borderTopWidth: "1px", "backgroundColor":
                                                        ...
                                                        <div className="framer-fjc7qo" data-framer-name="Content"><a className="framer-nah7t3 framer-yk3d88" data-framer-name="Figure" onClick={() => handleCausaClick(causa.id!)}
                                                            data-framer-page-link-current="true" style={{
                                                                "borderBottomLeftRadius":
                                                                    "6px", "borderBottomRightRadius": "6px", "borderTopLeftRadius": "6px",
                                                                "borderTopRightRadius": "6px"
                                                            }}>
                                                            <div className="framer-wk3qfq" data-framer-name="overlay" style={{ "backgroundColor": "var(--token-39994faa-240b-446c-8aa7-a268b7374093, rgb(82, 24, 7))", "opacity": "0.2" }}>
                                                            </div>
                                                            <figure className="framer-1rewzo1" data-framer-name="Image">
                                                                <div style={{ "position": "absolute", "borderTopLeftRadius": "inherit", "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "top": "0px", "right": "0px", "bottom": "0px", "left": "0px" }} data-framer-background-image-wrapper="true"><img decoding="async" width="1600" height="1209" sizes="(min-width: 1200px) max(max(max((min(100vw - 120px, 1440px) - 84px) / 3, 50px), 1px) - NaNpx, 1px), (max-width: 809px) max(max(min(100vw - 90px, 1440px), 1px) - NaNpx, 1px), (min-width: 810px) and (max-width: 1199px) max(max(max((min(100vw - 90px, 1440px) - 25px) / 2, 50px), 1px) - NaNpx, 1px)" src={imagemPrincipal}
                                                                    alt={causa.titulo} style={{ "display": "block", "width": "100%", "height": "100%", "borderTopLeftRadius": "inherit", "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "objectPosition": "center center", "objectFit": "cover" }} data-framer-original-sizes="max(max(min(100vw - 90px, 1440px), 1px) - NaNpx, 1px)" />
                                                                </div>
                                                            </figure>
                                                            <div className="framer-1lcshmx-container">
                                                                <div className="framer-aE08l framer-2Vypl framer-jRQOc framer-1bdcnzx framer-v-1bdcnzx" data-framer-name="Primary" style={{ "backgroundColor": "var(--token-065bffec-4ac7-4625-aced-acd0f0a75d90, rgb(254, 206, 102))", "borderBottomLeftRadius": "4px", "borderBottomRightRadius": "4px", "borderTopLeftRadius": "4px", "borderTopRightRadius": "4px" }}>
