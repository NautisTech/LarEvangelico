...
export function Causes({ causas }: { causas: ConteudoResumo[] }) {
	...
	function useCamposPersonalizados(
		campos_personalizados: ValorCampoPersonalizado[] | undefined
	) {
					...
					>
						<div className="ssr-variant">
							{causas.map((causa, index) => {
								...
								const objetivo = campos.getNumero("objetivo");

								return (
									<>
										<div className="ssr-variant hidden-d9yx5v hidden-utjgut">
											<div
										...
										<div className="ssr-variant hidden-d9yx5v hidden-wz6xei">
											<div
												className="framer-1plvl6g"
												style={{
													willChange: "transform",
										...
										<div className="ssr-variant hidden-utjgut hidden-wz6xei">
											<div
												className="framer-1plvl6g"
												style={{
													opacity: "1",
