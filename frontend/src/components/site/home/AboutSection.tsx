	...
	return (
		...
		>
			...
			{suffix && (
				// @ts-ignore
				<h5
					className="framer-text framer-styles-preset-1js54ic inline!"
					data-styles-preset="YoG87oFzq"
					style={{ marginTop: 0 }}
				>
					{suffix}
			...
			>
				<div className="framer-1di4fc7" data-framer-name="Container">
					<div className="ssr-variant hidden-181rvcf">
						...
						>
							<div
								className="framer-ipv7iz"
								data-framer-name="Every initiative, every donation, and every volunteer effort creates a lasting impact that fuels our mission of hope and change."
					...
					<div className="framer-1o6fogv" data-framer-name="Row">
						<div className="ssr-variant hidden-181rvcf">
							...
							>
									...
									>
										...
										>
											<img
												...
												width="450"
												height="650"
												sizes="(min-width: 1200px) max(min(100vw - 80px, 1440px) / 3.2, 1px), (min-width: 810px) and (max-width: 1199.98px) max(min(100vw - 50px, 1440px) / 3.2, 1px)"
												srcSet="/images/sR1KCPkAAyV9t8Vz8DfnzFs3E.jpg 450w?width=450&amp;height=650 450w"
												src="/images/sR1KCPkAAyV9t8Vz8DfnzFs3E.jpg?width=450&amp;height=650"
												alt="about-img"
												style={{
													display: "block",
													width: "100%",
								...
								<figure
									className="framer-dqfij hidden-181rvcf"
								...
								>
									...
									>
										<img
											...
											width="113"
											height="111"
											src="/images/KC3XgGjJl5Uwpb71fJe9sZN5E.svg?width=113&amp;height=111"
											alt="curve-shape"
											style={{
												display: "block",
												width: "100%",
						...
						>
							...
							>
								...
								<div className="ssr-variant hidden-181rvcf">
									...
									>
										<div className="framer-18knrvh-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-i6lblt"
												data-framer-name="15+"
											>
										...
										<div
											className="framer-kr7rhb hidden-181rvcf"
											data-framer-name="Line"
										></div>
										<div className="framer-7fhtx0-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-8fy3zm"
										...
										<div
											className="framer-q9ta9i hidden-181rvcf"
											data-framer-name="Line"
										></div>
										<div className="framer-55o8mi-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-145gr4a"
												data-framer-name="2+"
											>
												<div className="framer-ixvh3b-container">
													<Counter
								...
								<div className="ssr-variant hidden-mqny1y hidden-72rtr7">
									...
									>
										<div className="framer-18knrvh-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-4l9q58"
										...
										<div className="framer-7fhtx0-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-1j5pwvo"
										...
										<div className="framer-55o8mi-container">
											<div
												className="framer-BruZL framer-jRQOc framer-i6lblt framer-v-1h5kzkd"
							...
							<div className="ssr-variant hidden-181rvcf">
								<div
									className="framer-1szw48u-container"
									style={{
										willChange: "transform",
										opacity: "1",
										transform: "none",
