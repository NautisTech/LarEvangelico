export function OurProjects() {
    return (
        <>
            <section className="framer-1uj3j2o" data-framer-name="Insights">
                <div className="framer-4vodbq" data-framer-name="Container">
                    <div className="ssr-variant hidden-181rvcf">
                        <div className="framer-li2c55" data-framer-name="Dedicated Volunteers"
                    ...
                    <div className="framer-knc0ha" data-framer-name="Volunteers Lists">
                        <div className="ssr-variant hidden-181rvcf hidden-mqny1y">
                            <div className="framer-15rfd4u-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                        ...
                                        <figure className="framer-1hmeqbm" data-framer-name="Image">
                                            <div style={{
                                                ...
                                                <img decoding="async" width="768" height="455" sizes="(min-width: 1200px) max((min(100vw - 80px, 1440px) - 36px) / 2, 1px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 50px, 1440px) - 25px) / 2, 50px)"
                                                    ...
                                                    }} data-framer-original-sizes="max((min(100vw - 80px, 1440px) - 36px) / 2, 1px)"
                                                />
                                            </div>
                                        </figure>
                                    </div>
                                                ...
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        ...
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Reabilitação da Casa de Acolhimento <br /> (Lar de
                                                            Crianças e Jovens)</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Uma resposta social desenvolvida em equipamento destinado ao acolhimento
                                                            de crianças e jovens em situação de perigo</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Reabilitação da Casa de Acolhimento</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Lar de Crianças e Jovens</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                        ...
                        <div className="ssr-variant hidden-181rvcf hidden-mqny1y">
                            <div className="framer-12qs7wm-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Estrutura Residêncial para Pessoas Idosas <br />(Lar
                                                            de Idosos)</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Constitui uma resposta social desenvolvida em alojamento coletivo, temporário ou permanente, para
                                                            idosos.</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="ssr-variant hidden-mqny1y hidden-72rtr7">
                            <div className="framer-12qs7wm-container" style={{
                                ...
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-1hj6ybn"
                                    data-border="true" data-framer-name="Mobile" style={{
                                        borderBottomWidth: "1px", borderColor: "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                        borderStyle: "solid", borderTopWidth: "1px", borderBottomLeftRadius: "6px",
                                        borderBottomRightRadius: "6px", borderTopLeftRadius: "6px", borderTopRightRadius: "6px",
                                        width: "100%"
                                    }}>
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Estrutura Residêncial para Pessoas Idosas</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Lar de Idosos</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
