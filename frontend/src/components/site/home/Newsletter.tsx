...
export function Newsletter() {
	...
	return (
		<>
			<section
				className="framer-9g2wwu"
				data-framer-name="Newsletter Section"
			>
				<div
					className="framer-efeqm4 hidden-181rvcf"
					data-framer-name="Background"
				></div>
				<div className="ssr-variant hidden-181rvcf">
					<div
						className="framer-17bxnu9"
					...
					>
						<div
							className="framer-pqxrss"
							data-framer-name="Content"
						>
							<div
								className="framer-1jih8my"
								data-framer-name="Title Content"
							>
								<div
									className="framer-b7x78u"
									data-framer-name="Stay updated with the latest news"
								...
								<div
									className="framer-1adqti"
									data-framer-name="Get instant news by subscribe to our daily newsletter"
									data-framer-component-type="RichTextContainer"
									style={{
										transform: "none",
									}}
