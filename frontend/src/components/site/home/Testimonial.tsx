...
export function Testimonial() {
    return (
        <>
            <section className="framer-g0h04o" data-framer-name="Testimonials">
                <div className="framer-101xcqg" data-framer-name="Container Fluid">
                    <div className="ssr-variant hidden-181rvcf">
                        <div className="framer-1wgonh4" data-framer-name="Content" style={{
                            "willChange": "transform", "opacity": "1", "transform": "none"
                        }}>
                            <div className="framer-1ehknrp" data-framer-name="Arc Wrap">
                                <div className="framer-13ain9g-container" style={{
                                    "opacity": "1",
                                    "transform": "none"
                                }}>
                                    <svg className="transform-origin-center-center" style={{
                                        "width":
                                            "100%", "height": "100%", "transformOrigin": "center center"
                                    }} viewBox="0 0 100 100"
                                        overflow="visible">
                                ...
                                <div className="framer-1gmy2pl" data-framer-name="Logo r" style={{
                                    ...
                                    <div style={{
                                        ...
                                        <img decoding="async" width="715" height="715" sizes="(min-width: 1200px) 54px, (min-width: 810px) and (max-width: 1199.98px) 54px, (max-width: 809.98px) 54px"
                                            ...
                                            }} data-framer-original-sizes="54px" />
                                    </div>
                                </div>
                            </div>
                            <div className="framer-1123s25" data-framer-name="Content">
                                <div className="framer-72qu2n" data-framer-name="" data-framer-component-type="RichTextContainer" style={{ "transform": "none" }}>
                                    <h5 className="framer-text framer-styles-preset-1js54ic" data-styles-preset="YoG87oFzq" style={{ textAlign: "center" }}>"A Fundação Lar Evangélico Português tem transformado
                                        vidas com dedicação, fé e amor. Ver o impacto do trabalho com crianças, jovens e idosos é
                                        profundamente inspirador. É um privilégio fazer parte desta missão de esperança e serviço ao
                                        próximo."</h5>
                                </div>
                                <div className="framer-1oa6qa" data-framer-name="— Emily Carter, Volunteer Coordinator" data-framer-component-type="RichTextContainer" style={{ "transform": "none" }}>
                                    <p className="framer-text framer-styles-preset-myx315" data-styles-preset="SArK0nEOS" style={{ textAlign: "center" }}>— Maria Silva, Voluntária da Fundação</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="ssr-variant hidden-mqny1y hidden-72rtr7">
                        <div className="framer-1wgonh4" data-framer-name="Content" style={{ "opacity": "1", "transform": "none" }}>
                            <div className="framer-1ehknrp" data-framer-name="Arc Wrap">
                            ...
                            <div className="framer-1123s25" data-framer-name="Content">
                                <div className="framer-72qu2n" data-framer-name="" data-framer-component-type="RichTextContainer"
                                    style={{ "transform": "none" }}>
                                    <h5 className="framer-text framer-styles-preset-1js54ic" data-styles-preset="YoG87oFzq"
                                        style={{ textAlign: "center" }}>"A Fundação Lar Evangélico Português tem transformado
                                        vidas com dedicação, fé e amor. Ver o impacto do trabalho com crianças, jovens e idosos é
                                        profundamente inspirador. É um privilégio fazer parte desta missão de esperança e serviço ao
                                        próximo."</h5>

                                </div>
                                <div className="framer-1oa6qa" data-framer-name="— Emily Carter, Volunteer Coordinator"
                                    ...
                                    <p className="framer-text framer-styles-preset-myx315" data-styles-preset="SArK0nEOS"
                                        style={{ textAlign: "center" }}>— Maria Silva, Voluntária da Fundação</p>
                                </div>
                            </div>
                        </div>
                    </div >
                    <div className="framer-pfeccf" data-framer-name="Gallery Wrap">
                        <div className="ssr-variant hidden-181rvcf hidden-mqny1y">
                            <div className="framer-ad7lp4-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-mXgNe framer-5ah1tl framer-v-5ah1tl" data-framer-name="Primary"
                                    style={{ "width": "100%" }}>
                                    <div className="framer-1mrrnc5-container">
                                        <section style={{
                                            "display": "flex", "width": "100%", "height": "100%",
                                            "maxWidth": "100%", "maxHeight": "100%", "alignItems": "center", "justifyItems":
                                                "center", "marginTop": "0px", "marginRight": "0px", "marginBottom": "0px",
                                            "marginLeft": "0px", "paddingTop": "10px", "paddingRight": "10px", "paddingBottom":
                                                "10px", "paddingLeft": "10px", "listStyleType": "none", "opacity": "1",
                                            ...
                                            <ul style={{
                                                ...
                                                "maxWidth": "100%", "maxHeight": "100%", "alignItems": "center", "justifyItems":
                                                    "center", "marginTop": "0px", "marginRight": "0px", "marginBottom": "0px",
                                                "marginLeft": "0px", "paddingTop": "0px", "paddingRight": "0px", "paddingBottom":
                                                    "0px", "paddingLeft": "0px", "listStyleType": "none", "rowGap": "24px",
                                                "columnGap": "24px", "position": "relative", "flexDirection": "row", "willChange":
                                                    "auto", "transform": "translateX(0px)"
                                            }}>
                                                <li>
                                                    <div className="framer-1fvk6tu" data-framer-name="image 1" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                            "position": "absolute", "borderTopLeftRadius": "inherit",
                                                            "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
                                                ...
                                                <li>
                                                    <div className="framer-ov878w" data-framer-name="image 2" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                ...
                                                <li>
                                                    <div className="framer-tghefv" data-framer-name="image 3" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                ...
                                                <li>
                                                    <div className="framer-5fw7b3" data-framer-name="image 4" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                ...
                                                <li>
                                                    <div className="framer-6kdhak" data-framer-name="image 5" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                ...
                                                <li>
                                                    <div className="framer-f4c7r1" data-framer-name="image 6" style={{
                                                        "borderBottomLeftRadius": "12px", "borderBottomRightRadius": "12px", "borderTopLeftRadius":
                                                            "12px", "borderTopRightRadius": "12px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                        ...
                        <div className="ssr-variant hidden-mqny1y hidden-72rtr7">
                            <div className="framer-ad7lp4-container" style={{
                                "opacity": "1",
                                "transform": "scale(0.7)", "transformOrigin": "0% 0% 0px"
                            }}>
                                <div className="framer-mXgNe framer-5ah1tl framer-v-5ah1tl" data-framer-name="Primary"
                                                ...
                                                <li>
                                                    <div className="framer-1fvk6tu" data-framer-name="image 1" style={{
                                                        "borderBottomLeftRadius": "6px", "borderBottomRightRadius": "6px", "borderTopLeftRadius":
                                                            "6px", "borderTopRightRadius": "6px", "flexShrink": "0"
                                                    }}>
                                                        <div style={{
                                                            "position": "absolute", "borderTopLeftRadius": "inherit",
                                                            "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
