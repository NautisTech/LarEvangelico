...
export function MainBanner() {
	...
	return (
		<>
			<section
				className="framer-1gttmjx"
				data-framer-name="Main Banner"
				id="home-banner"
			>
				<div
					className="framer-1qhwegm hidden-181rvcf"
				...
				>
					...
					>
						<img
							...
							width="1523"
							height="928"
							sizes="(min-width: 1200px) calc(100vw * 0.81), (min-width: 810px) and (max-width: 1199.98px) calc(100vw * 0.81), (max-width: 809.98px) calc(100vw * 0.81)"
				...
				<div className="ssr-variant hidden-181rvcf">
					...
					>
						<div
							className="framer-1r64dt9"
							data-framer-name="Column"
						>
							<div
								className="framer-vdwpde"
								data-framer-name="Title"
							>
								<div
									className="framer-10v0ihx"
									data-framer-name="Empower change, one act of kindness at a time"
								...
								<div
									className="framer-1vp12jf"
									data-framer-name="Animated Text"
								>
									<div
										className="framer-17l2m5j"
										data-framer-name="Empower change, one act of kindness at a time"
										data-framer-component-type="RichTextContainer"
										style={{
											transform: "none",
									...
									>
										...
										>
											{t("banner.title_animated")}
										</h1>
									</div>
									<div
										className="framer-13ur03w"
								...
								>
									...
									>
										{t("banner.title_part3")}
									</h1>
								</div>
							</div>
							<div
								className="framer-1ynk84e-container"
								onClick={handleModalOpen}
							>
								<a
									className="framer-EomdA framer-2Vypl framer-rvcmdt framer-v-8usv35 framer-1d5tuq9"
									data-border="true"
									data-framer-name="Banner Button"
									style={{
						...
						<div
							className="framer-qwty79"
							data-framer-name="Column"
						>
							<div className="ssr-variant hidden-mqny1y">
								<div
									className="framer-1ex2qhx"
								...
								>
									...
									>
										<img
											...
											width="568"
											height="520"
											sizes="(min-width: 1200px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 112px) / 2.6, 1px) * 0.7397)"
											...
											src="/images/88L9qYTuUycsTgr56XHCoBqCxw.jpg?width=568&amp;height=520"
								...
								>
									...
									>
										<img
											...
											width="568"
											height="520"
											sizes="(min-width: 810px) and (max-width: 1199.98px) calc(min(max(100vw - 50px, 1px), 1440px) * 0.4), (max-width: 809.98px) calc(min(100vw - 50px, 1440px) * 0.4)"
							...
							>
								...
								<div
									className="framer-nssx0z"
									data-border="true"
									data-framer-name="Line"
								></div>
								<div className="ssr-variant hidden-mqny1y">
									<div
										className="framer-urdj5y"
									...
									>
										...
										>
											<img
												...
												width="768"
												height="975"
												sizes="(min-width: 1200px) max((min(max(100vw - 80px, 1px), 1440px) - 112px) / 2.6, 1px), (min-width: 810px) and (max-width: 1199.98px) calc(min(max(100vw - 50px, 1px), 1440px) * 0.55)"
												srcSet="/images/8V218xbriPZK5bYQY2v8G2qE.jpg 768w?width=768&amp;height=975 768w"
												src="/images/8V218xbriPZK5bYQY2v8G2qE.jpg?width=768&amp;height=975"
												alt="home-banner"
												style={{
													display: "block",
													width: "100%",
								...
								>
									...
									>
										<img
											...
											width="768"
											height="975"
											sizes="(max-width: 809.98px) calc(min(100vw - 50px, 1440px) * 0.55)"
