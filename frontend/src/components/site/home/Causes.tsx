...
export function Causes({ causas, isLoading }: { causas: Conteudo[], isLoading: boolean }) {
                            ...
                            <div className="framer-1lcshmx-container">
                                <div className="framer-aE08l framer-2Vypl framer-jRQOc framer-1bdcnzx framer-v-1bdcnzx"
                                    ...
                                    <div className="framer-1y22eeh" data-framer-name="$114,000" data-framer-component-type="RichTextContainer" style={{ "transform": "none" }}>
                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw">{causa.objetivo}</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" focusable="false"
                                            ...
                                            style={{
                                                ...
                                                "display": "inline-block", "fill":
                                                    "var(--extracted-r6o4lv, var(--token-76b9cbad-4dc8-4bc3-a43b-d42a9da69ee1, rgb(29, 15, 2)))", "color":
                                                    "var(--extracted-r6o4lv, var(--token-76b9cbad-4dc8-4bc3-a43b-d42a9da69ee1, rgb(29, 15, 2)))", "flexShrink": "0"
                                            }}>
