    ...
    return (
        <>
            <section className="framer-1m4rlcb" data-framer-name="Positive Impact">
                <div className="framer-14ul55h" data-framer-name="Container Fluid">
                    <div className="ssr-variant hidden-bvam2o">
                        <div className="framer-iskrt3 hidden-1q641mp" data-framer-name="Icon"
                            style={{
                    ...
                    <div className="ssr-variant hidden-1cn8rbi hidden-1q641mp">
                        <div className="framer-iskrt3 hidden-1q641mp" data-framer-name="Icon"
                            style={{
                                "willChange": "transform", "opacity": "1", "transform":
                                    "translateX(-43px) translateY(17px)"
                            }}>
                            <div style={{
                                "position": "absolute", "borderTopLeftRadius": "inherit",
                                "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
                    ...
                    <div className="ssr-variant hidden-1q641mp">
                        <div className="framer-12bn0wo" data-framer-name="Title Content" style={{
                            "willChange": "transform", "opacity": "1", "transform": "none"
                        }}>
                            <div className="framer-hysl85" data-framer-name="The Meaningful ways we create lasting positive impact"
                                data-framer-component-type="RichTextContainer" style={{
                                    "transform":
                                        "none"
                                }}>
                                <h2 className="framer-text framer-styles-preset-s0nzzz" data-styles-preset="N1eiVmsrJ">As formas
                                    significativas como criamos impacto positivo duradouro</h2>
                    ...
                    <div className="framer-ribbmr" data-framer-name="Row">
                        <div className="framer-i3h5em" data-framer-name="Main">
                            <div className="ssr-variant hidden-1q641mp">
                                <div className="framer-znqfu" data-framer-name="Figure" style={{
                                    "willChange": "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div className="ssr-variant hidden-bvam2o">
                                        <figure className="framer-14gyw3e" data-framer-name="image">
                                            <div style={{
                                                "position": "absolute", "borderTopLeftRadius": "inherit",
                                                "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
                                                "borderBottomLeftRadius": "inherit", "top": "0px", "right": "0px", "bottom": "0px", "left":
                            ...
                            <div className="ssr-variant hidden-1q641mp">
                                <div className="framer-7foo0m" data-framer-name="Content" style={{
                                    "willChange": "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div className="framer-7v95g6" data-framer-name="Title Content">
                                        <div className="framer-5sbq4y" data-framer-name="Creating Lasting Change"
                                            data-framer-component-type="RichTextContainer" style={{
                                                "transform":
                                                    "none"
                                            }}>
                                            <h4 className="framer-text framer-styles-preset-13lkd54" data-styles-preset="SE0dvQEiW">Criando
                                                Mudança com Amor e Esperança</h4>

                                        </div>
                                        <div className="framer-166n4xg" data-framer-name="We provide essential resources like food, education, and emergency aid to vulnerable communities. Our initiatives focus on making a lasting impact by addressing critical needs. Through collaboration with volunteers and donors, we ensure that help reaches those who need it most."
                                            data-framer-component-type="RichTextContainer" style={{
                                                "transform":
                                                    "none"
                                            }}>
                                            <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw">A Fundação Lar Evangélico Português atua nas áreas da infância, juventude
                                                e terceira idade, acolhendo e cuidando de quem mais precisa.
                                                <br className="framer-text"
                                                />Através das nossas respostas sociais — Casa de Acolhimento (CA) e Estrutura
                                                Residencial para Pessoas Idosas (ERPI) — promovemos bem-estar, formação
                        ...
                        <div className="framer-1muyvsg hidden-1q641mp" data-framer-name="Figure"
                            style={{ "willChange": "transform", "opacity": "1", "transform": "none" }}>
                            <div className="ssr-variant hidden-bvam2o">
                                <figure className="framer-18455q3" data-framer-name="image">
                                    <div style={{
                                        "position": "absolute", "borderTopLeftRadius": "inherit",
                                        "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
                                        "borderBottomLeftRadius": "inherit", "top": "0px", "right": "0px", "bottom": "0px", "left":
