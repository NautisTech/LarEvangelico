    ...
    return (
        <>
            <section className="framer-14g44ew" data-framer-name="Volunteers">
                <div className="framer-1xr30rs hidden-bvam2o hidden-1q641mp" data-framer-name="Icon"
                    style={{
                        "willChange": "transform", "opacity": "1", "transform":
                            "translate(-50%, -50%)"
                    }}>
                    <div style={{
                        ...
                        <img decoding="async" loading="lazy" width="509" height="469" src="images/PDUdhaT6kIJeJsFU6FktFSR0des.png?width=509&amp;height=469"
                            alt="Curve line" style={{
                ...
                <section className="framer-1rfqhtm" data-framer-name="Volunteers">
                    <div className="framer-cdlm87" data-framer-name="Container">
                        <div className="ssr-variant hidden-1q641mp">
                            <div className="framer-14yoz1b" data-framer-name="Dedicated Volunteers"
                        ...
                        <div className="framer-g5mjfs" data-framer-name="Volunteers Lists">
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-7ef3b0-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
                                            ...
                                            <figure className="framer-1hmeqbm" data-framer-name="Image">
                                                <div style={{
                                                    ...
                                                    <img decoding="async" loading="lazy" width="684" height="762" sizes="(min-width: 1200px) max((min(100vw - 160px, 1440px) - 72px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 100px, 1440px) - 25px) / 2, 50px)"
                                                        ...
                                                        }} data-framer-original-sizes="max((min(100vw - 160px, 1440px) - 72px) / 3, 50px)"
                                                    />
                                                </div>
                                            </figure>
                                        </div>
                                                    ...
                                                    <img decoding="async" loading="lazy" width="684" height="762" sizes="(min-width: 1200px) max((min(100vw - 160px, 1440px) - 72px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 100px, 1440px) - 25px) / 2, 50px)"
                                                        ...
                                                        alt="Emily Johnson" style={{
                                                            ...
                                                            "height": "100%", "borderTopLeftRadius": "inherit", "borderTopRightRadius":
                                                                "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius":
                                                                "inherit", "objectPosition": "center top", "objectFit": "cover"
                                                        }} data-framer-original-sizes="max((min(100vw - 100px, 1440px) - 25px) / 2, 50px)"
                                                    />
                                                </div>
                                            </figure>
                                        </div>
                                                    ...
                                                    <img decoding="async" width="684" height="762" sizes="(max-width: 809.98px) min(100vw - 100px, 1440px)"
                                                        ...
                                                        alt="Emily Johnson" style={{
                                                            ...
                                                            "height": "100%", "borderTopLeftRadius": "inherit", "borderTopRightRadius":
                                                                "inherit", "borderBottomRightRadius": "inherit", "borderBottomLeftRadius":
                                                                "inherit", "objectPosition": "center top", "objectFit": "cover"
                                                        }} data-framer-original-sizes="min(100vw - 100px, 1440px)"
                                                    />
                                                </div>
                                            </figure>
                                        </div>
                            ...
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-1n6b3j8-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
                            ...
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-1d6ax1b-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
                            ...
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-okym0o-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
                            ...
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-1dfvmfy-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
                            ...
                            <div className="ssr-variant hidden-bvam2o hidden-1q641mp">
                                <div className="framer-1u8q5if-container" style={{
                                    "willChange":
                                        "transform", "opacity": "1", "transform": "none"
                                }}>
                                    <div
