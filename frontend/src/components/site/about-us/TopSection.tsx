									...
									>
										<div className="framer-pnytwb-container">
											...
											>
												<div className="framer-ixvh3b-container">
													<div
														className="framer-YkOfG framer-RcNjK framer-oGK70 framer-1bucv7k framer-v-spcx1z"
														data-framer-name="24+"
														style={{
															height: "100%",
														}}
													>
														<div
															className="framer-1hfwia1"
															data-framer-name="Number"
														>
															<div
																className="framer-r5yy2t"
																data-framer-name="0"
																data-framer-component-type="RichTextContainer"
																style={{
																	transform:
										...
										<div className="framer-1odkg23-container">
											...
											>
												<div className="framer-ixvh3b-container">
													<div
														className="framer-YkOfG framer-RcNjK framer-oGK70 framer-1bucv7k framer-v-1fiz7wp"
														data-framer-name="6M+"
														style={{
															height: "100%",
														}}
