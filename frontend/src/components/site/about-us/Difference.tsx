export function Difference() {
    return (
        <>
            <section className="framer-pf87j3" data-framer-name="Difference">
                <div className="ssr-variant hidden-1q641mp">
                    <div className="framer-17jc25y" data-framer-name="Background Image" style={{
                        "willChange": "transform", "opacity": "1", "transform": "none"
                    }}>
                        <div className="framer-1s7icyn" data-framer-name="Image" style={{
                            "willChange": "transform", "opacity": "1", "transform": "none"
                        }}>
                            <div style={{
                ...
                <div className="framer-rcjp5e" data-framer-name="Container">
                    <div className="ssr-variant hidden-1q641mp">
                        <div className="framer-1eufe6v" data-border="true" data-framer-name="Box"
                            style={{ "willChange": "transform", "opacity": "1", "transform": "none" }}>
                            <div className="framer-12wuw4b" data-framer-name="Content">
                                <div className="framer-uldfvh" data-framer-name="Title Content">
                                    <div className="framer-8kx79u" data-framer-name="Join us in making a difference"
                                        data-framer-component-type="RichTextContainer" style={{
                                            "transform":
                                                "none"
                                        }}>
                                        <h2 className="framer-text framer-styles-preset-s0nzzz" data-styles-preset="N1eiVmsrJ">Junta-te a nós
                                            para fazer a diferença</h2>

                                    </div>
                                    <div className="framer-komnuc" data-framer-name="Your support can help change lives and transform communities. Whether through donations, volunteering, or spreading awareness, every action counts."
                                        data-framer-component-type="RichTextContainer" style={{
                                            "transform":
                                                "none"
                                        }}>
                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw">O voluntariado é uma expressão de cidadania e solidariedade.
                                            <br className="framer-text"
                                            />Na Fundação Lar Evangélico Português, os voluntários partilham tempo,
                                            talento e amor com crianças, jovens e idosos, contribuindo para o seu bem-estar
                                            e crescimento integral.</p>
                                    </div>
                                </div>
                                <div className="ssr-variant hidden-bvam2o">
                                    <div className="framer-1hjkkti-container"><a className="framer-EomdA framer-2Vypl framer-rvcmdt framer-v-rvcmdt framer-1d5tuq9"
                    ...
                    <div className="ssr-variant hidden-1cn8rbi hidden-bvam2o">
                        <div className="framer-1eufe6v" data-border="true" data-framer-name="Box"
                            ...
                            <div className="framer-12wuw4b" data-framer-name="Content">
                                ...
                                <div className="framer-1hjkkti-container"><a className="framer-EomdA framer-2Vypl framer-rvcmdt framer-v-blbcci framer-1d5tuq9"
