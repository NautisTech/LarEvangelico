export function Volunteers() {
    return (
        <>
            <section className="framer-1gjzbl6" data-framer-name="Volunteers">
                <div className="framer-n6mbe6" data-framer-name="Container">
                    <div className="ssr-variant hidden-1w2ghag">
                        <div className="framer-159h8km" data-framer-name="Dedicated Volunteers"
                            ...
                            <h2 className="framer-text framer-styles-preset-s0nzzz" data-styles-preset="N1eiVmsrJ"
                                style={{ textAlign: "center" }}><strong className="framer-text">Juntos por uma Causa Maior</strong>
                            </h2>
                    ...
                    <div className="framer-1jku1pk" data-framer-name="Volunteers Lists">
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-26r7eq-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                    data-border="true" data-framer-name="Primary" style={{
                                        ...
                                        borderStyle: "solid", borderTopWidth: "1px", "borderBottomLeftRadius": "12px",
                                        "borderBottomRightRadius": "12px", "borderTopLeftRadius": "12px", "borderTopRightRadius":
                                            "12px", "width": "100%"
                                    }}>
                                    <div className="framer-qblcbl" data-framer-name="Figure">
                                        <figure className="framer-1hmeqbm" data-framer-name="Image">
                                            <div style={{
                                                ...
                                                <img decoding="async" loading="lazy" width="1024" height="1278" sizes="(min-width: 1200px) max((min(100vw - 80px, 1440px) - 72px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 50px, 1440px) - 25px) / 2, 50px)"
                                                    ...
                                                    style={{
                                                        ...
                                                        "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "objectPosition":
                                                            "center top", "objectFit": "cover"
                                                    }} data-framer-original-sizes="max((min(100vw - 80px, 1440px) - 72px) / 3, 50px)"
                                                />
                                            </div>
                                        </figure>
                                    </div>
                                    <div className="framer-13rcw7b" data-border="true" data-framer-name="Hover Content"
                                        style={{
                                            borderBottomWidth: "1px", borderColor:
                                                "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                        ...
                                        <div className="framer-d4uxgw" data-framer-name="Content">
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        ...
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>3ª Igreja Batista do Porto</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Apoio espiritual e comunitário</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Apoia o Lar Evangélico com acompanhamento pastoral, iniciativas solidárias
                                                        e momentos de partilha e fé.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-1y9xiyb hidden-1w2ghag">
                            <div className="framer-26r7eq-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                            ...
                                            <div style={{
                                                ...
                                                <img decoding="async" width="1024" height="1278" sizes="(min-width: 1200px) max((min(100vw - 80px, 1440px) - 72px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 50px, 1440px) - 25px) / 2, 50px)"
                                                    ...
                                                    style={{
                                                        ...
                                                        "borderBottomRightRadius": "inherit", "borderBottomLeftRadius": "inherit", "objectPosition":
                                                            "center top", "objectFit": "cover"
                                                    }} data-framer-original-sizes="max((min(100vw - 50px, 1440px) - 25px) / 2, 50px)"
                                                />
                                            </div>
                                        </figure>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-1y9xiyb hidden-yz9twz">
                            <div className="framer-26r7eq-container" style={{
                                ...
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-1hj6ybn"
                                    data-border="true" data-framer-name="Mobile" style={{
                                        borderBottomWidth: "1px", borderColor:
                                            "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                        borderStyle: "solid", borderTopWidth: "1px", "borderBottomLeftRadius": "6px",
                                        "borderBottomRightRadius": "6px", "borderTopLeftRadius": "6px", "borderTopRightRadius": "6px",
                                        "width": "100%"
                                    }}>
                                    <div className="framer-qblcbl" data-framer-name="Figure">
                                        <figure className="framer-1hmeqbm" data-framer-name="Image">
                        ...
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-167rtil-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                                ...
                                                <img decoding="async" loading="lazy" width="1024" height="1353" sizes="(min-width: 1200px) max((min(100vw - 80px, 1440px) - 72px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 50px, 1440px) - 25px) / 2, 50px)"
                                                    ...
                                                    alt="Michael Lee" style={{
                                                        ...
                                                        "height": "100%", "borderTopLeftRadius": "inherit", "borderTopRightRadius":
                                                            ...
                                                            "inherit", "objectPosition": "center top", "objectFit": "cover"
                                                    }} data-framer-original-sizes="max((min(100vw - 80px, 1440px) - 72px) / 3, 50px)"
                                                />
                                            </div>
                                        </figure>
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Acampamento Batista</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Formação e integração juvenil</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>O Acampamento Batista promove atividades educativas e de lazer para crianças
                                                        e jovens.</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-1x1l5fr-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>APAV</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Parceria no apoio a vítimas</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Juntos trabalhamos para apoiar famílias e indivíduos em situações de vulnerabilidade.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-1e2ow5h-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>EBM International</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Cooperação missionária</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Em conjunto, apoiamos ações de ajuda humanitária e desenvolvimento comunitário.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-1nezpcn-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>IEBC</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Envolvimento comunitário</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>A IEBC é parceira ativa nas iniciativas sociais e espirituais do Lar.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-yz9twz hidden-1w2ghag">
                            <div className="framer-1991h9l-container" style={{
                                "willChange":
                                    "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Segurança Social</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Inclusão social e capacitação</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Apoia e supervisiona as nossas respostas sociais, garantindo a qualidade,
                                                        o rigor e o apoio às populações mais vulneráveis.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-1w2ghag">
                            <div className="framer-1iz9900-container hidden-1y9xiyb hidden-yz9twz">
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-1hj6ybn"
                                    data-border="true" data-framer-name="Mobile" style={{
                                        borderBottomWidth: "1px", borderColor:
                                            "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Câmara Municipal</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Apoio institucional</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>A Câmara Municipal da Maia apoia o Lar Evangélico em diversas iniciativas
                                                        sociais.</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="ssr-variant hidden-1w2ghag">
                            <div className="framer-1yhbjif-container hidden-1y9xiyb hidden-yz9twz">
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-1hj6ybn"
                                    data-border="true" data-framer-name="Mobile" style={{
                                        borderBottomWidth: "1px", borderColor:
                                            "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Junta de Freguesia</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Colaboração em projetos sociais</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Colabora em projetos que promovem a solidariedade e o apoio aos mais vulneráveis.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="ssr-variant hidden-1w2ghag">
                            <div className="framer-x1apgc-container hidden-1y9xiyb hidden-yz9twz">
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-1hj6ybn"
                                    data-border="true" data-framer-name="Mobile" style={{
                                        borderBottomWidth: "1px", borderColor:
                                            "var(--token-4e132b7a-8408-4224-bc97-7e71f267842c, rgb(215, 201, 183))", borderLeftWidth: "1px", borderRightWidth: "1px",
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    <div className="framer-19u0f6p" data-framer-name="Michael Lee" data-framer-component-type="RichTextContainer"
                                                        style={{ "transform": "none" }}>
                                                        <h6 className="framer-text framer-styles-preset-9i5qw2" data-styles-preset="OXZ7pDCA2"
                                                            style={{ textAlign: "center" }}>Lions Clube Maia</h6>
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Solidariedade e apoio a causas sociais</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
                                                ...
                                                <div className="framer-19el9nk" data-framer-name="Emily leads efforts to connect with local communities, ensuring our programs meet their needs and provide lasting impact."
                                                    ...
                                                    <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                        style={{ textAlign: "center" }}>Juntos realizamos ações que melhoram vidas e fortalecem o espírito de
                        ...
                        <div className="ssr-variant hidden-yz9twz">
                            <div className="framer-pw6fjg-container hidden-1w2ghag" style={{
                        ...
                        <div className="ssr-variant hidden-yz9twz">
                            <div className="framer-1bhs67m-container hidden-1w2ghag" style={{
                                "willChange": "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                    data-border="true" data-framer-name="Primary" style={{
                        ...
                        <div className="ssr-variant hidden-yz9twz">
                            <div className="framer-rebifx-container hidden-1w2ghag" style={{
                                "willChange": "transform", "opacity": "1", "transform": "none"
                            }}>
                                <div className="framer-8c8gv framer-u5oc0 framer-jRQOc framer-12a1avi framer-v-12a1avi"
                                    data-border="true" data-framer-name="Primary" style={{
                                            ...
                                            <div className="framer-16e2iw7" data-framer-name="Top">
                                                <div className="framer-1e5gl14" data-framer-name="Title Content">
                                                    ...
                                                    <div className="framer-7em9ca" data-framer-name="Volunteer Program Manager"
                                                        ...
                                                        <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw"
                                                            style={{ textAlign: "center" }}>Apoio a causas sociais</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="framer-1l2dmvv" data-framer-name="Bottom" style={{
