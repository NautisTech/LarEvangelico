            ...
            <section className="framer-1sd4mu2" data-framer-name="Change">
                <div className="framer-qjfh8j" data-framer-name="Container">
                    <div className="ssr-variant hidden-1w2ghag">
                        <div className="framer-1tzjaqe" data-framer-name="Title Content" style={{
                            "willChange": "transform", "opacity": "1", "transform": "none"
                        }}>
                            <div className="framer-4l2eqe" data-framer-name="Be part of the change"
                                data-framer-component-type="RichTextContainer" style={{
                                    "transform":
                                        "none"
                                }}>
                                <blockquote className="framer-text">
                                    <h2 className="framer-text framer-styles-preset-172snon" data-styles-preset="ayQ9EeMdI"><strong className="framer-text">Faz parte da mudança</strong></h2>

                                </blockquote>
                            </div>
                            <div className="ssr-variant hidden-yz9twz">
                                <div className="framer-jq2fr9-container"><a className="framer-EomdA framer-2Vypl framer-rvcmdt framer-v-rvcmdt framer-1d5tuq9"
                    ...
                    <div className="ssr-variant hidden-1y9xiyb hidden-yz9twz">
                        <div className="framer-1tzjaqe" data-framer-name="Title Content" style={{
                            ...
                            <div className="framer-jq2fr9-container"><a className="framer-EomdA framer-2Vypl framer-rvcmdt framer-v-1cm66cn framer-1d5tuq9"
                    ...
                    <div className="ssr-variant hidden-1w2ghag">
                        <div className="framer-1gzj85h" data-framer-name="Content" style={{
                            "willChange": "transform", "opacity": "1", "transform": "none"
                        }}>
                            <div className="framer-bjuegi" data-framer-name="Shape" style={{
                            ...
                            <div className="framer-hbnpvf" data-framer-name="Figure">
                                <div className="ssr-variant hidden-yz9twz">
                                    <figure className="framer-1ictc7e" data-framer-name="Image">
                                        <div style={{
                                            "position": "absolute", "borderTopLeftRadius": "inherit",
                                            "borderTopRightRadius": "inherit", "borderBottomRightRadius": "inherit",
                                            "borderBottomLeftRadius": "inherit", "top": "0px", "right": "0px", "bottom": "0px", "left":
                            ...
                            <div className="framer-7mxq5i" data-framer-name="Join our growing community of volunteers and become a force htmlFor good. Whether big or small, every act of kindness helps create a brighter future htmlFor those in need."
                                data-framer-component-type="RichTextContainer" style={{
                                    "transform":
                                        "none"
                                }}>
                                <p className="framer-text framer-styles-preset-18rceng" data-styles-preset="efNb1Kccw">Junta-te à nossa comunidade de voluntários e torna-te uma htmlForça do
                                    bem. Seja grande ou pequeno, cada gesto de bondade ajuda a construir um
                                    futuro mais luminoso para quem mais precisa.</p>
                            </div>
                        </div>
                    </div>
                    <div className="ssr-variant hidden-1y9xiyb hidden-yz9twz">
